...
void MainWindow::addMeteoPoints()
{
    ...
    for (int i = 0; i < myProject.nrMeteoPoints; i++)
    {
        ...
        point->setToolTip();
        connect(point, SIGNAL(newStationClicked(std::string, std::string, std::string, std::string, bool)), this, SLOT(callNewMeteoWidget(std::string, std::string, std::string, std::string, bool)));
        connect(point, SIGNAL(appendStationClicked(std::string, std::string, std::string, std::string, bool)), this, SLOT(callAppendMeteoWidget(std::string, std::string, std::string, std::string, bool)));
...
void MainWindow::callNewMeteoWidget(std::string id, std::string name, std::string dataset, std::string lapseRate, bool isGrid)
{
    bool isAppend = false;
    if (isGrid)
    {
    ...
    {
        myProject.showMeteoWidgetPoint(id, name, dataset, lapseRate, isAppend);
    }
    return;
}

void MainWindow::callAppendMeteoWidget(std::string id, std::string name, std::string dataset, std::string lapseRate, bool isGrid)
{
    bool isAppend = true;
    if (isGrid)
    {
