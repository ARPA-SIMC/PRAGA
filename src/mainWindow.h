...
#define MAINWINDOW_H
    ...
    private slots:
        ...
        void callNewMeteoWidget(std::string id, std::string name, std::string dataset, std::string lapseRate, bool isGrid);
        void callAppendMeteoWidget(std::string id, std::string name, std::string dataset, std::string lapseRate, bool isGrid);
