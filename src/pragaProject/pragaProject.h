...
#define PRAGAPROJECT_H
    ...
    public:
        ...
        bool interpolationCrossValidationPeriod(QDate dateIni, QDate dateFin, meteoVariable myVar, QString filename, int nrDaysLoading);
        ...
        bool elaborationCycleGridDaily(bool isAnomaly, bool showInfo);
        ...
        bool computeRadiationList(const QString &fileName, QString folderString);
